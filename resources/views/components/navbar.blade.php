                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="{{ route('barangs.index') }}"
                           class="rounded-md px-3 py-2 text-sm font-medium
                           {{ request()->routeIs('barangs.*') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                            Barang
                        </a>
                        ...
                        <a href="{{ route('suppliers.index') }}"
                           class="rounded-md px-3 py-2 text-sm font-medium
                           {{ request()->routeIs('suppliers.*') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                            Supplier
                        </a>
                        ...
                        <a href="{{ route('transaksis.index') }}"
                           class="rounded-md px-3 py-2 text-sm font-medium
                           {{ request()->routeIs('transaksis.*') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
                            Transaksi
                        </a>
